...
const Delete = () => (
  <svg
    ...
    className="w-[16px] h-[16px] sm:w-[20px] sm:h-[20px] mq2000:w-[32px] mq2000:h-[32px]"
  >
    <path
...
const Search = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="absolute top-[50%] left-[13px] translate-y-[-50%] mq2000:w-[28px] mq2000:h-[28px]"
  >
    <path
...
const Dice = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="w-[16px] h-[16px] sm:w-[24px] sm:h-[24px] mq2000:w-[38px] mq2000:h-[38px]"
  >
    <path
