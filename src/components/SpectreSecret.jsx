...
function SpectreSecret() {
  return (
    <>
     <section className="w-full h-[480px] relative bg-[#0e1a60]">
          <section className="flex flex-col sm:flex-row justify-between w-full relative z-10">
            <section className="flex flex-col gap-[10px] sm:gap-[30px] sm:w-[43%] items-start sm:px-[60px] sm:pt-[70px]">
              {/* Button */}
              <button
                className="rounded-[12px] border-[0.8px] border-[#fff] backdrop-blur-[11px] flex justify-between p-[5px] items-center text-[#EFFAFF] font-[400] text-[12px] sm:text-[16px] xs:leading-[64px] h-[39px] dm-sans outline-none min-w-[210px] md:w-[212px]"
                style={{
            ...
            <section className="flex relative flex-col gap-[10px] sm:gap-[30px] sm:w-[45%]">
              <div
                className="w-[471.7px] relative h-[575.53px] rounded-[19.73px] flex flex-col justify-center text-center border-[1px] border-[#ffffff94] px-[25px] py-[8px]"
                style={{
                  background: `
              ...
              >
                  <img
                      ...
                      className="w-full pr-11 pb-[350px] absolute z-0"
                    />
                <div className="flex flex-col gap-1 relative z-10">
                  <label
                    htmlFor="name"
                    className="flex items-center text-[#FFFFFFB2] text-[16px] leading-[19.69px] font-sans gap-[0.5px]"
                  >
                    <svg
                      width="23"
                      height="22"
                  ...
                  <input
                    ...
                    id="name"
                    placeholder="Name"
                    className="p-2 rounded-[8px] w-[418.89px] h-[46.54px] bg-[#0E1A60] text-white focus:outline-none"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1">
                  <label
                    htmlFor="secretKey"
                    className="flex items-center text-[#FFFFFFB2] text-[16px] leading-[19.69px] gap-[1.5px] font-sans"
                  >
                    <img src="\secret.svg" />
                    Your Spectre Secret
                  </label>
                ...
                <div className="flex flex-col gap-1">
                  <label
                    htmlFor="name"
                    className="flex items-center text-[#FFFFFFB2] text-[16px] gap-[2px] leading-[19.69px] font-sans"
                  >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="bg-[#2A3992] w-[418.89px] h-[46.54px] rounded-[5.37px] flex justify-between items-center px-3 focus:outline-none">
                    <div className="text-white text-[16px] leading-[19.69px] font-[700]">
                      Cor657656
                    </div>
                    <div
                      style={{
                      ...
                      className="flex items-center justify-center w-[41.17px] h-[36.7px] rounded-[5.37px]"
                    >
                      <svg
                        width="22"
                        height="23"
                ...
                <p className="text-[12px] mt-4 leading-[19.69px] text-[#FFFFFFB2]">
                  The information never leaves this page
                </p>
                <span className="mt-5"><svg
                  width="431"
                  height="4"
                  viewBox="0 0 431 4"
                  fill="none"
