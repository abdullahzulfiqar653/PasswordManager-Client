      ...
      <section className="w-full h-[480px] relative bg-[#0e1a60]">
        <section className="flex flex-col sm:flex-row justify-between sm:justify-arround px-[11px] sm:px-[0px] sm:gap-[250px] sm:pl-[60px]  pb-32 sm:pb-52 mq1024:pr-20 mq1150:pr-48 mq2400:pr-72 mq2400:pl-36 w-full relative z-10">
          <section className="flex flex-col gap-[10px] sm:gap-[30px] mq2000:gap-[50px] sm:w-[43%] items-start pb-[140px] sm:pb-0 sm:pt-[70px]">
            {/* Button */}
            <button
              className="rounded-[12px] border-[0.8px] border-[#fff] backdrop-blur-[11px] flex justify-between p-[5px] items-center mq2000:text-[32px] text-[#EFFAFF] font-[400] text-[12px] sm:text-[16px] xs:leading-[64px] h-[39px] mq2000:h-[69px] dm-sans outline-none w-[175px] md:w-[212px] mq2000:w-[450px]"
              style={{
            ...
            {/* Headline */}
            <h1 className="text-white text-[32px] sm:w-full md:text-[66px] font-[400] mq2000:text-[86px] mq2000:leading-[85px] leading-[36px] md:leading-[61px]">
              Password <br /> without saving <br /> password
            </h1>
            <h1 className="text-[#FFFFFFB2] font-sans text-[12px] md:text-[18px] font-[400] leading-[15.62px] md:leading-[22px] mq2000:text-[32px] mq2000:leading-[40px]">
          ...
          <section className="flex relative flex-col justify-center items-center sm:gap-[30px] mq1500:mt-9 mq2000:mt-0">
            ...
            >
              <img
                ...
                className="w-full pr-7 sm:pr-11 pb-[320px] sm:pb-[350px] mq1600:pr-16 mq1600:pb-[500px] mq2000:pb-[720px]  absolute z-0"
              />
              <div className="flex flex-col gap-1 mq2000:gap-3 relative z-20 mt-5 sm:mt-0">
                <label
                  htmlFor="name"
                  className="flex font-sans  items-center text-[#FFFFFFB2] text-[12px] sm:text-[16px] mq1600:text-[22px] mq2000:text-[32px] leading-[19.69px]  gap-[0.5px]"
                >
                  <svg
                    width="23"
                    height="22"
                    ...
                    className="mq1600:h-[32px] mq1600:w-[33px] mq2000:h-[45px] mq2000:w-[45px]"
                  >
                    <path
                      opacity="0.4"
                ...
                <input
                  ...
                  className="p-2 text-[14px] font-sans  sm:text-[16px] mq1600:text-[22px] mq2000:text-[32px] font-[700] rounded-[4.49px] sm:rounded-[8px] mq350:w-[280.86px]  mq400:w-[309.86px] mq425:w-[349.86px] h-[38.87px] sm:w-[418.89px] sm:h-[46.54px] mq1600:w-[460px] mq1600:h-[60px] mq2000:w-[660px] mq2000:h-[75px] bg-[#0E1A60] text-white focus:outline-none"
                />
              </div>
              <div className="flex justify-center mb-3 mt-1 mq1600:mb-8 mq1600:mt-4 mq2000:mb-12 mq2000:mt-8">
                <h1 className="text-[16.11px] mq1600:text-[23.11px] mq2000:text-[38.11px] h-[20px] w-[11px] text-[#A143FF] font-[500]">
                  X
                </h1>
              </div>
              <div className="flex flex-col gap-1 mq2000:gap-3 relative z-20">
                <label
                  htmlFor="secretKey"
                  className="flex items-center text-[#FFFFFFB2] text-[12px] sm:text-[16px] mq1600:text-[22px] mq2000:text-[32px]  leading-[19.69px] gap-[1.5px] font-sans"
                >
                  <img src="\secret.svg" className="mq1600:h-[32px] mq1600:w-[33px] mq2000:h-[45px] mq2000:w-[45px]" />
                  Your Spectre Secret
                </label>
                <input
                  type="password"
              ...
              <div className="flex flex-col items-center text-center mb-1 mt-6">
                <p>
                  ...
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="mq350:w-[320px] w-[350px] sm:w-[431px] mq1600:w-[500px]"
                  >
                    <path
                ...
                <p className="mt-3 mq1600:mt-6 mq2000:mt-12">
                  <svg
                    width="13"
                    height="16"
                    viewBox="0 0 13 16"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="mq1600:h-[26px] mq1600:w-[26px] mq2000:w-[36px] mq2000:h-[36px]"
                  >
                    <path
              ...
              <div className="flex flex-col gap-1 mq2000:gap-3 relative z-20 ">
                <label
                  htmlFor="name"
                  className="flex items-center text-[#FFFFFFB2] text-[12px] sm:text-[16px] mq1600:text-[22px] mq2000:text-[32px]  gap-[2px] leading-[19.69px] font-sans"
                >
                  <img src="\site_domain.svg"  className="mq1600:h-[32px] mq1600:w-[33px] mq2000:h-[45px] mq2000:w-[45px]"/>
                  Sit Domain
                </label>
                <input
                  type="url"
                  ...
                  value={formData.url}
                  onChange={handleChange}
                  className="p-2 rounded-[4.49px] font-sans  text-[14px] sm:text-[16px] mq1600:text-[22px] mq2000:text-[32px]  font-[700] sm:rounded-[8px] mq350:w-[280.86px]  mq400:w-[309.86px] mq425:w-[349.86px] h-[38.87px] sm:w-[418.89px] sm:h-[46.54px] mq1600:w-[460px] mq1600:h-[60px] mq2000:w-[660px] mq2000:h-[75px] bg-[#0E1A60] text-white focus:outline-none"
                />
              </div>
              <div className="flex justify-center mb-3 mt-3 mq1600:mb-6 mq1600:mt-6 mq2000:mb-12 mq2000:mt-12">
                <h1 className="text-[21.48px] mq1600:text-[30px] mq2000:text-[50px] leading-[16.96px] h-[20px] w-[11px]  text-[#A143FF] font-[500]">
                  =
                </h1>
              </div>
              <div className="flex flex-col gap-1 mq2000:gap-3 ">
                <label
                  htmlFor="secretKey"
                  className="flex items-center text-[#FFFFFFB2] text-[16px] mq1600:text-[22px] mq2000:text-[32px]  leading-[19.69px] gap-[2px] font-sans"
                >
                  <img src="\pass_lock.svg" className="mq1600:h-[32px] mq1600:w-[33px] mq2000:h-[45px] mq2000:w-[45px]" />
                  Site Password
                </label>
                <div className="bg-[#2A3992] mq350:w-[280.86px] mq400:w-[309.86px] mq425:w-[349.86px] h-[38.87px] sm:w-[418.89px] sm:h-[46.54px] mq1600:w-[460px] mq1600:h-[60px] mq2000:w-[660px] mq2000:h-[75px] rounded-[4.49px] sm:rounded-[5.37px] flex justify-between items-center px-3 focus:outline-none">
                  ...
                  <div
                   ...
                   hover:shadow-lg hover:shadow-slate-800 cursor-pointer justify-center relative z-30  w-[34.39px] h-[30.65px] sm:w-[41.17px] sm:h-[36.7px] mq1600:h-[45px] mq1600:w-[51px] mq2000:h-[62px] mq2000:w-[71px] rounded-[5.37px]"
                  >
                    {isCopied ? (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        width="19px"
                        fill="white"
                        className="mq1600:h-[34px] mq1600:w-[34px] mq2000:h-[44px] mq2000:w-[44px]"
                      >
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="mq1600:h-[34px] mq1600:w-[34px] mq2000:h-[52px] mq2000:w-[52px]"
                      >
                        <path
              ...
              <p className="text-[12px] mq1600:text-[18px] mq1600:mt-8 mq2000:text-[26px] mq2000:mt-14  mt-2 sm:mt-4 font-sans leading-[19.69px] text-[#FFFFFFB2]">
                The information never leaves this page
              </p>
              <span className="mt-3 sm:mt-5 mq2000:mt-10">
                <svg
                  width="431"
                  height="4"
                  viewBox="0 0 431 4"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="mq350:w-[320px] w-[350px] sm:w-[431px] mq1600:w-[530px] mq2000:w-[660px]"
                >
                  <path
        ...
        <img
          src="\webSectBG.svg"
          className="absolute hidden top-[-440px] mq2000:top-[-680px] mq2400:top-[-800px] w-full sm:block sm:object-cover z-0"
